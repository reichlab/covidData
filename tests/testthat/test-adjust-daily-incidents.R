...
new_inc_case_a = adjust_daily_incidence(data, adjustments[1,], seed, measure = 'death')

new_inc_case_b = adjust_daily_incidence(data, adjustments[2,], seed, measure = 'death' )
